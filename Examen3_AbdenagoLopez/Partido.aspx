<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="Partido.aspx.cs" Inherits="Examen2.Equipos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container text-center">
        ...
        Tipo: <asp:TextBox ID="ttipo" class="form-control" runat="server"></asp:TextBox>
 ...
 <br />
     ...
     <div class="container text-center">
        ...
        <asp:Button ID="Button4" runat="server" class="btn btn-outline-danger" Text="Modificar" OnClick="Button4_Click1" />
